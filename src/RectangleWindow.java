...
public class RectangleWindow extends javax.swing.JFrame {
    ...
    private void submitDrawActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitDrawActionPerformed
        ...
        //Gets the size of the sides of the rectangle
        int xIntSize = (Integer)xSize.getValue();
        int yIntSize = (Integer)ySize.getValue();
        //This try catch exception method is here because LogData will be using file handling which will need a IOException.
        try{
    ...
    private void mainMenuButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mainMenuButtonActionPerformed
        // TODO add your handling code here:
        //This will remove the rectangle window.
        this.dispose();
        //this will create a new drawShapeWindow which will allow the user to go back to the 
        //"Main menu"
